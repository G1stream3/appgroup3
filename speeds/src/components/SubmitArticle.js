...
class SubmitArticle extends Component {
  ...
  onSubmit = e => {
    ...
    axios
      .post('https://speedappgroup3.herokuapp.com/api/articles', data) //send data to database then empty form details
      .then(res => {
        this.setState({
          title:'',
          author:'',
      ...
      <div className="SubmitArticle">
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-8 m-auto">
              <h1 className="display-4 text-center">Submit Article（speed）</h1>
              <p className="lead text-center">
               Please enter information for data submission
              </p>
              ...
              <form noValidate onSubmit={this.onSubmit}>
                ...
                />
                <p className="lead text-center">
                Developers: Chenhui Lin, Yubo Wang, Angus Jiang
              </p>
